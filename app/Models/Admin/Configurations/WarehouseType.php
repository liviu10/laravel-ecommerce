...
class WarehouseType extends Model
{
    ...
    /**
     * Eloquent relationship between warehouse_types and invoice_lines.
     *
     */
    ...
    /**
     * Eloquent relationship between warehouse_types and sales_invoice_lines.
     *
     */
    ...
    /**
     * Eloquent relationship between warehouse_types and consumption_receipts.
     *
     */
    ...
    /**
     * Eloquent relationship between warehouse_types and shipping_notes.
     *
     */
    ...
    public function fetchAllRecords()
    {
        try
        {
            return $this->select('id', 'code', 'name', 'type')->get();
        }
    ...
    public function orderTableColumn($payload)
    {
        try
        {
            return $this->select('id', 'code', 'name', 'type')
    ...
    public function filterTableColumn($payload)
    {
        try
        {
            if ($payload['column_name'] === 'code' || $payload['column_name'] === 'type')
            {
                return $this->select('id', 'code', 'name', 'type')
