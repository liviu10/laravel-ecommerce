...
class ShippingNote extends Model
{
     ...
     * @var string
     */
    protected $table = 'shipping_notes';
     ...
     * @var string
     */
    protected $salesInvoiceForeignKey = 'sales_invoice_id';
     ...
     * @var string
     */
    protected $salesInvoiceForeignKeyType = 'int';
    ...
    /**
     * Eloquent relationship between shipping_notes and document_types.
     *
     */
    ...
    /**
     * Eloquent relationship between shipping_notes and warehouse_types.
     *
     */
    ...
    /**
     * Eloquent relationship between shipping_notes and sales_invoice.
     *
     */
    ...
    /**
     * Eloquent relationship between shipping_notes and vat_types.
     *
     */
    ...
    /**
     * Eloquent relationship between shipping_notes and sales_invoice_lines.
     *
     */
    ...
    /**
     * SQL queries to fetch shipping note details.
     * @param  int  $id
     *
     */
                    ...
                    ->with([
                        ...
                        'sales_invoice' => function ($query) {
                            $query->select(
                                        ...
                                        'sales_invoice_lines' => function ($query) {
                                            $query->select(
                                                        'id', 'sales_invoice_id', 'product_type_id',
