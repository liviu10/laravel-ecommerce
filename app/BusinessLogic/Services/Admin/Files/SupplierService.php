...
use App\Models\Admin\Files\Supplier;
use Illuminate\Database\Eloquent\Collection;

/**
 * SupplierService is a service class the will implement all the methods from the SupplierInterface contract and will handle the business logic.
 */
