...
/**
 * ShippingNoteService is a service class the will implement all the methods from the ShippingNoteInterface contract and will handle the business logic.
 */
class ShippingNoteService implements ShippingNoteInterface
{
    ...
    public function handleStore(ShippingNoteRequest $request)
    {
        $apiInsertRecord = [
            ...
            'sales_invoice_id'      => $request->get('sales_invoice_id'),
