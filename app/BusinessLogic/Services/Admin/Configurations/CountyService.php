...
/**
 * CountyService is a service class the will implement all the methods from the CountyInterface contract and will handle the business logic.
 */
class CountyService implements CountyInterface
{
