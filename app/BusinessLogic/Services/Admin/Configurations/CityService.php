...
/**
 * CityService is a service class the will implement all the methods from the CityInterface contract and will handle the business logic.
 */
class CityService implements CityInterface
{
    ...
    public function handleStore(CityRequest $request)
    {
        $apiInsertRecord = [
            ...
            'siruta_code'     => $request->get('siruta_code'),
