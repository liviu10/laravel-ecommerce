...
/**
 * DocumentTypeService is a service class the will implement all the methods from the DocumentTypeInterface contract and will handle the business logic.
 */
class DocumentTypeService implements DocumentTypeInterface
{
    ...
    {
        $this->modelName = new DocumentType();
    }
