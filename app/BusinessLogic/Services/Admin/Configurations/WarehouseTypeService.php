...
/**
 * WarehouseTypeService is a service class the will implement all the methods from the WarehouseTypesInterface contract and will handle the business logic.
 */
class WarehouseTypeService implements WarehouseTypeInterface
{
