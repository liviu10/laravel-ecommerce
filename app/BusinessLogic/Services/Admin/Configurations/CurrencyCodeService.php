...
/**
 * CurrencyCodeService is a service class the will implement all the methods from the CurrencyCodeInterface contract and will handle the business logic.
 */
class CurrencyCodeService implements CurrencyCodeInterface
{
    ...
    {
        $this->modelName = new CurrencyCode();
    }
