...
/**
 * ProductTypeService is a service class the will implement all the methods from the ProductTypesInterface contract and will handle the business logic.
 */
class ProductTypeService implements ProductTypeInterface
{
    ...
    {
        $this->modelName = new ProductType();
    }
