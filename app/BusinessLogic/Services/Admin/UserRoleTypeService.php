...
use App\Http\Requests\Admin\UserRoleTypeRequest;
...
class UserRoleTypeService implements UserRoleTypeInterface
{
     ...
     * @param  UserRoleTypeRequest  $request
     * @return \Illuminate\Http\Response
     */
    public function handleStore(UserRoleTypeRequest $request)
    {
        $apiInsertRecord = [
     ...
     * @return \Illuminate\Http\Response
     */
    public function handleUpdate(UserRoleTypeRequest $request, $id)
    {
        $apiUpdateRecord = [
            'account_type_id' => $request->get('account_type_id'),
            'code'            => $request->get('code'),
