...
use App\Models\Admin\Connect\ContactMe;
use Illuminate\Database\Eloquent\Collection;

/**
 * ContactMeService is a service class the will implement all the methods from the ContactMeInterface contract and will handle the business logic.
 */
class ContactMeService implements ContactMeInterface
{
