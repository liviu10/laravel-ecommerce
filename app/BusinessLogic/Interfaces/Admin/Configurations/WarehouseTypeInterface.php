...
/**
 * WarehouseTypeInterface is a contract for what methods will be used in the WarehouseTypeService class.
...
interface WarehouseTypeInterface
{
     ...
     * @param App\Http\Requests\Configurations\WarehouseTypeRequest $request
     * @return \Illuminate\Http\Response
     */
