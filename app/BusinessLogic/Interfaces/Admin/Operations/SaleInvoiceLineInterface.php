...
/**
 * SaleInvoiceLineInterface is a contract for what methods will be used in the SaleInvoiceLineService class.
 ...
 * - handleRestoreRecord();
 */
interface SaleInvoiceLineInterface
{
    /**
     ...
     * @param App\Http\Requests\Operations\SaleInvoiceLineRequest $request
     * @return \Illuminate\Http\Response
     */
