...
class CreateSuppliersTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('suppliers', function (Blueprint $table) {
            ...
            $table->foreignId('account_id')->index('idx_supplier_account_id');
            $table->foreignId('country_id')->index('idx_supplier_country_id');
            $table->foreignId('county_id')->index('idx_supplier_county_id');
            $table->foreignId('city_id')->index('idx_supplier_city_id');
